...
class DataView(context: Context) : View(context) {
    ...
    override fun onDraw(canvas: Canvas?) {
        ...
        val bitmapWidth = if (bitmap == null) dpToPx(15, context) else dpToPx(70, context)
    ...
    fun bind(item: Data) {
        ...
        bitmap = null
        invalidate()
        val bitmapUrl = if (item.ICON.thumbnailUrl != "") item.ICON.thumbnailUrl else "https://kotlinlang.ru/img/kotlin-logo.png"
